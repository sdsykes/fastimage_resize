...
Gem::Specification.new do |s|
  ...
  s.date = %q{2009-07-07}
  s.description = %q{FastImageResize is an extremely light solution for resizing images in ruby by using libgd.}
  ...
  s.summary = %q{FastImage - Image resizing fast and simple}
